import type { LanyardData } from "./restTypes";
...
export interface LanyardEvent<T extends LanyardEventType>
  extends LanyardMessage<LanyardEvents[T]> {
...
export interface LanyardInitialize
  extends LanyardMessage<LanyardInitializeData> {
